...
public class RxInfiniteRecyclerViewActivity extends AppCompatActivity {
    ...
    private void parseData(int resId){
        ...
        // Creating adapter
        RxInfiniteRecyclerViewAdapter adapter = new RxInfiniteRecyclerViewAdapter(pages.removeFirst(), (RxInfiniteRecyclerViewAdapter.Listener) new InfiniteScrollingListener());
